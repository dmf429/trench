      ...
      <div style={{ paddingTop: '52px' }}>
                  ...
                  {rooms.map(room => {
                    ...
                    return (
                      <div key={room.id}
                        ...
                        style={{ background: '#0a0a10', border: '1px solid #1a1a2e', padding: '16px', cursor: 'pointer', transition: 'all 0.15s' }}
        ...
        {tab === 'waitlist' && (
          <div style={{ textAlign: 'center', padding: '80px 24px' }}>
            ...
            <div style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '12px', color: '#6666aa', maxWidth: '440px', margin: '0 auto 32px', lineHeight: 1.8 }}>First 1,000 wallets get lifetime access to premium features and priority $TRENCH allocation.</div>
            <a href="/waitlist" style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '11px', letterSpacing: '2px', color: '#050508', background: '#00FF88', padding: '14px 32px', textDecoration: 'none', clipPath: 'polygon(10px 0%,100% 0%,calc(100% - 10px) 100%,0% 100%)', display: 'inline-block' }}>JOIN WAITLIST →</a>
          </div>
        )}
      </div>
    </div>
