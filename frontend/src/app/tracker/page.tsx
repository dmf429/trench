...
export default function TrackerPage() {
  ...
  const [sort, setSort] = useState('pnl7d')
  ...
  return (
    <div style={{minHeight:'100vh',background:'#050508',color:'#e0e0f0',fontFamily:"'DM Sans',sans-serif"}}>
      ...
      <div style={{maxWidth:'1200px',margin:'0 auto',padding:'72px 24px 48px'}}>
        ...
        {/* Add Wallet */}
        <div style={{background:'#0a0a10',border:'1px solid #1a1a2e',padding:'16px',marginBottom:'24px',display:'flex',alignItems:'center'}}>
...
function KOLRow({kol, tracked, onToggle, fmt}) {
  return (
    <div style={{display:'grid',gridTemplateColumns:'200px 100px 100px 100px 80px 80px 110px 100px',padding:'12px 16px',background:tracked?'rgba(0,255,136,0.03)':'transparent',borderBottom:'1px solid #0d0d18',borderLeft:`2px solid ${tracked?'#00FF88':'transparent'}`,transition:'background 0.15s'}}
      onMouseEnter={e=>e.currentTarget.style.background='#0a0a10'}
      onMouseLeave={e=>e.currentTarget.style.background=tracked?'rgba(0,255,136,0.03)':'transparent'}
    >
